 ...
 */
final class Version20231218063712 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP category_id, CHANGE cart_id cart_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD category_id INT NOT NULL, CHANGE cart_id cart_id INT DEFAULT NULL');
